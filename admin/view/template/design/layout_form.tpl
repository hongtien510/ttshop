            ...
            <tbody>
              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][position]" class="form-control">
                    ...
                    <?php } ?>
                    <?php if ($layout_module['position'] == 'content_top_bottom') { ?>
                    <option value="content_top_bottom" selected="selected"><?php echo $text_content_top_bottom; ?></option>
                    <?php } else { ?>
                    <option value="content_top"><?php echo $text_content_top_bottom; ?></option>
                    <?php } ?>
...
function addModule() {
    ...
    html += '    <option value="content_top_bottom"><?php echo $text_content_top_bottom; ?></option>';
